...
/******************************************************************************/
#define AI_AUDIO_MODEL_NAME          "audio"
#define AI_AUDIO_ORIGIN_MODEL_NAME   "audio_class_quant"

/******************************************************************************/
#define AI_AUDIO_ACTIVATIONS_ALIGNMENT   (4)
#define AI_AUDIO_INPUTS_IN_ACTIVATIONS   (4)
#define AI_AUDIO_OUTPUTS_IN_ACTIVATIONS  (4)
...
AI_DEPRECATED
#define AI_AUDIO_IN \
  ai_audio_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUDIO_IN_SIZE { \
  AI_AUDIO_IN_1_SIZE, \
}
#define AI_AUDIO_IN_SIZE_BYTES { \
  AI_AUDIO_IN_1_SIZE_BYTES, \
}
#define AI_AUDIO_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_AUDIO_IN_1_CHANNEL     (40)
#define AI_AUDIO_IN_1_SIZE        (40)
#define AI_AUDIO_IN_1_SIZE_BYTES  (40)
...
AI_DEPRECATED
#define AI_AUDIO_OUT \
  ai_audio_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUDIO_OUT_SIZE { \
  AI_AUDIO_OUT_1_SIZE, \
}
#define AI_AUDIO_OUT_SIZE_BYTES { \
  AI_AUDIO_OUT_1_SIZE_BYTES, \
}
#define AI_AUDIO_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_AUDIO_OUT_1_CHANNEL     (5)
#define AI_AUDIO_OUT_1_SIZE        (5)
#define AI_AUDIO_OUT_1_SIZE_BYTES  (5)

/******************************************************************************/
#define AI_AUDIO_N_NODES (5)
 ...
 * @ref ai_audio_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_audio_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_AUDIO_*
 * defines into file @ref audio.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
